...
return new class extends Migration
{
    ...
    {
        Schema::create('bk_home_visit', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('lokasi_kunjungan', 180)->nullable();
            $table->string('tujuan_kunjungan', 200);
    ...
    {
        Schema::dropIfExists('bk_home_visit');
    }
};
