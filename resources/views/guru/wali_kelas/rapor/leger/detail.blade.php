...
<div class="container-fluid">
  ...
  <div class="d-flex align-items-center mb-3">
    <a href="{{ route('guru.wali-kelas.rapor.leger.index') }}" class="btn btn-link p-0 mr-2" title="Kembali">
    ...
    <div class="card-body pb-2">
      <div class="d-flex justify-content-between align-items-center">
        <div class="d-flex" style="gap:8px;">
          <button class="btn btn-light btn-sm" type="button" disabled>Excel</button>
          <button class="btn btn-light btn-sm" type="button" disabled>PDF</button>
        </div>
