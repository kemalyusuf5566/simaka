        ...
        <tbody>
          ...
          @forelse($kelas as $i => $k)
            <tr>
              ...
              <td>
                <a href="{{ route('guru.wali-kelas.absensi.kelola', $k->id) }}" class="btn btn-success btn-sm">
          ...
          @empty
            <tr>
              <td colspan="5" class="text-center text-muted py-4">Anda belum menjadi wali kelas.</td>
            </tr>
          @endforelse
        </tbody>
      </table>
